                      ...
                      <form method="post" action="">
                        <div class="mb-3">
                         ...
                         <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="editSchool<?=$row["SchoolID"]?>" aria-describedby="editSchool<?=$row["SchoolID"]?>Help" name="sState" value="<?=$row['State']?>">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="editSchool<?=$row["SchoolID"]?>" aria-describedby="editSchool<?=$row["SchoolID"]?>Help" name="sCity" value="<?=$row['City']?>">
