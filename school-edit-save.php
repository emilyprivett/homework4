...
$sState = $_POST['sState'];
$sCity = $_POST['sCity'];
$sql = "UPDATE School SET SchoolName=?, State=?, City=? WHERE SchoolID=?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("sssi",$sName,$sState,$sCity, $_POST['scid']); 
$stmt->execute();
?>
...
<a href="school.php" class= "btn btn primary">Go Back!</a>
